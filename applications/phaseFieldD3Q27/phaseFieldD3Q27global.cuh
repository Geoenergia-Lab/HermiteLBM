...
#define launchBoundsD3Q27 __launch_bounds__(block::maxThreads(), MIN_BLOCKS_PER_MP())
     ...
     **/
    launchBoundsD3Q27 __global__ void phaseFieldNormals(
        ...
        const device::ptrCollection<6, scalar_t> ghostPhase)
    {
        ...
        if (isInterior)
        {
            ...
            const label_t xp1_yp1_zp1 = i_xp + dyp + dzp;
            const label_t xp1_yp1_zm1 = i_xp + dyp - dzm;
            const label_t xp1_ym1_zp1 = i_xp - dym + dzp;
            const label_t xp1_ym1_zm1 = i_xp - dym - dzm;
            const label_t xm1_yp1_zp1 = i_xm + dyp + dzp;
            const label_t xm1_yp1_zm1 = i_xm + dyp - dzm;
            const label_t xm1_ym1_zp1 = i_xm - dym + dzp;
            const label_t xm1_ym1_zm1 = i_xm - dym - dzm;
            ...
            const scalar_t scx = VelocitySet::w_1<scalar_t>() * (normx[i_xp] - normx[i_xm]) +
                                 ...
                                 VelocitySet::w_3<scalar_t>() * (normx[xp1_yp1_zp1] - normx[xm1_ym1_zm1] +
                                                                 normx[xp1_yp1_zm1] - normx[xm1_ym1_zp1] +
                                                                 normx[xp1_ym1_zp1] - normx[xm1_yp1_zm1] +
                                                                 normx[xp1_ym1_zm1] - normx[xm1_yp1_zp1]);
            ...
            const scalar_t scy = VelocitySet::w_1<scalar_t>() * (normy[i_yp] - normy[i_ym]) +
                                 ...
                                 VelocitySet::w_3<scalar_t>() * (normy[xp1_yp1_zp1] - normy[xm1_ym1_zm1] +
                                                                 normy[xp1_yp1_zm1] - normy[xm1_ym1_zp1] +
                                                                 normy[xm1_yp1_zm1] - normy[xp1_ym1_zp1] +
                                                                 normy[xm1_yp1_zp1] - normy[xp1_ym1_zm1]);
            ...
            const scalar_t scz = VelocitySet::w_1<scalar_t>() * (normz[i_zp] - normz[i_zm]) +
                                 ...
                                 VelocitySet::w_3<scalar_t>() * (normz[xp1_yp1_zp1] - normz[xm1_ym1_zm1] +
                                                                 normz[xm1_ym1_zp1] - normz[xp1_yp1_zm1] +
                                                                 normz[xp1_ym1_zp1] - normz[xm1_yp1_zm1] +
                                                                 normz[xm1_yp1_zp1] - normz[xp1_ym1_zm1]);

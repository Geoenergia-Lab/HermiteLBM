...
#define launchBoundsD3Q27 __launch_bounds__(block::maxThreads(), 2)
#endif
     ...
     **/
    launchBoundsD3Q27 __global__ void phaseFieldPrimePhaseHalo(
        const device::ptrCollection<NUMBER_MOMENTS<true>(), scalar_t> devPtrs,
     ...
     **/
    launchBoundsD3Q27 __global__ void phaseFieldPrimePhiHalo(
        const device::ptrCollection<NUMBER_MOMENTS<true>(), scalar_t> devPtrs,
        const device::ptrCollection<6, scalar_t> ghostPhiWrite)
    {
        const thread::coordinate Tx;

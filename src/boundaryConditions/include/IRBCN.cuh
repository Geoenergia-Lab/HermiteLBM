...
case normalVector::FRONT():
{
    ...
    {
        const scalar_t mxx_I = (pop[q_i<1>()] + pop[q_i<2>()] + pop[q_i<7>()] + pop[q_i<8>()] + pop[q_i<9>()] + pop[q_i<13>()] + pop[q_i<14>()] + pop[q_i<16>()]) - velocitySet::cs2<scalar_t>() * p_I;
        const scalar_t mxy_I = (pop[q_i<7>()] + pop[q_i<8>()] - pop[q_i<13>()] - pop[q_i<14>()]);
        const scalar_t mxz_I = (pop[q_i<9>()] - pop[q_i<16>()]);
        const scalar_t myy_I = (pop[q_i<3>()] + pop[q_i<4>()] + pop[q_i<7>()] + pop[q_i<8>()] + pop[q_i<11>()] + pop[q_i<13>()] + pop[q_i<14>()] + pop[q_i<18>()]) - velocitySet::cs2<scalar_t>() * p_I;
        const scalar_t myz_I = (pop[q_i<11>()] - pop[q_i<18>()]);
    ...
    {
        const scalar_t mxx_I = (pop[q_i<1>()] + pop[q_i<2>()] + pop[q_i<7>()] + pop[q_i<8>()] + pop[q_i<9>()] + pop[q_i<13>()] + pop[q_i<14>()] + pop[q_i<16>()] + pop[q_i<19>()] + pop[q_i<22>()] + pop[q_i<23>()] + pop[q_i<25>()]) - velocitySet::cs2<scalar_t>() * p_I;
        const scalar_t mxy_I = (pop[q_i<7>()] + pop[q_i<8>()] - pop[q_i<13>()] - pop[q_i<14>()] + pop[q_i<19>()] + pop[q_i<22>()] - pop[q_i<23>()] - pop[q_i<25>()]);
        const scalar_t mxz_I = (pop[q_i<9>()] - pop[q_i<16>()] + pop[q_i<19>()] - pop[q_i<22>()] + pop[q_i<23>()] - pop[q_i<25>()]);
        const scalar_t myy_I = (pop[q_i<3>()] + pop[q_i<4>()] + pop[q_i<7>()] + pop[q_i<8>()] + pop[q_i<11>()] + pop[q_i<13>()] + pop[q_i<14>()] + pop[q_i<18>()] + pop[q_i<19>()] + pop[q_i<22>()] + pop[q_i<23>()] + pop[q_i<25>()]) - velocitySet::cs2<scalar_t>() * p_I;
        const scalar_t myz_I = (pop[q_i<11>()] - pop[q_i<18>()] + pop[q_i<19>()] - pop[q_i<22>()] - pop[q_i<23>()] + pop[q_i<25>()]);
...
case normalVector::WEST_FRONT():
{
    ...
    if constexpr (VelocitySet::Q() == 19)
    {
        const scalar_t mxy_I = (pop[q_i<8>()] - pop[q_i<14>()]);
        const scalar_t myz_I = (pop[q_i<11>()] - pop[q_i<18>()]);
    ...
    {
        const scalar_t mxy_I = (pop[q_i<8>()] - pop[q_i<14>()] + pop[q_i<22>()] - pop[q_i<25>()]);
        const scalar_t myz_I = (pop[q_i<11>()] - pop[q_i<18>()] - pop[q_i<22>()] + pop[q_i<25>()]);
...
case normalVector::EAST_FRONT():
{
    ...
    if constexpr (VelocitySet::Q() == 19)
    {
        const scalar_t mxy_I = (pop[q_i<7>()] - pop[q_i<13>()]);
        const scalar_t myz_I = (pop[q_i<11>()] - pop[q_i<18>()]);
    ...
    {
        const scalar_t mxy_I = (pop[q_i<7>()] - pop[q_i<13>()] + pop[q_i<19>()] - pop[q_i<23>()]);
        const scalar_t myz_I = (pop[q_i<11>()] - pop[q_i<18>()] + pop[q_i<19>()] - pop[q_i<23>()]);
...
case normalVector::SOUTH_FRONT():
{
    ...
    if constexpr (VelocitySet::Q() == 19)
    {
        const scalar_t mxy_I = (pop[q_i<8>()] - pop[q_i<13>()]);
        const scalar_t mxz_I = (pop[q_i<9>()] - pop[q_i<16>()]);
    ...
    {
        const scalar_t mxy_I = (pop[q_i<8>()] - pop[q_i<13>()] + pop[q_i<22>()] - pop[q_i<23>()]);
        const scalar_t mxz_I = (pop[q_i<9>()] - pop[q_i<16>()] - pop[q_i<22>()] + pop[q_i<23>()]);
...
case normalVector::NORTH_FRONT():
{
    ...
    if constexpr (VelocitySet::Q() == 19)
    {
        const scalar_t mxy_I = (pop[q_i<7>()] - pop[q_i<14>()]);
        const scalar_t mxz_I = (pop[q_i<9>()] - pop[q_i<16>()]);
    ...
    {
        const scalar_t mxy_I = (pop[q_i<7>()] - pop[q_i<14>()] + pop[q_i<19>()] - pop[q_i<25>()]);
        const scalar_t mxz_I = (pop[q_i<9>()] - pop[q_i<16>()] + pop[q_i<19>()] - pop[q_i<25>()]);

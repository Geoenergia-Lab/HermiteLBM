...
case normalVector::WEST_NORTH():
{
    ...
    else
    {
        ...
        moments[m_i<4>()] = moments[m_i<1>()] * moments[m_i<1>()];                                                                                                               // mxx
        moments[m_i<5>()] = moments[m_i<1>()] * moments[m_i<2>()];                                                                                                               // mxy
        moments[m_i<6>()] = (static_cast<scalar_t>(45) * mxz_I + static_cast<scalar_t>(9) * myz_I + static_cast<scalar_t>(5) * moments[m_i<3>()]) / (static_cast<scalar_t>(18)); // mxz
        moments[m_i<7>()] = moments[m_i<2>()] * moments[m_i<2>()];                                                                                                               // myy
        moments[m_i<8>()] = (static_cast<scalar_t>(9) * mxz_I + static_cast<scalar_t>(45) * myz_I - static_cast<scalar_t>(5) * moments[m_i<3>()]) / (static_cast<scalar_t>(18)); // myz
...
case normalVector::NORTH():
{
    ...
    if constexpr (VelocitySet::Q() == 19)
    {
        moments[m_i<4>()] = (static_cast<scalar_t>(4) * mxx_I - static_cast<scalar_t>(4) * mzz_I + static_cast<scalar_t>(3) * moments[m_i<1>()] * moments[m_i<1>()] + static_cast<scalar_t>(3) * moments[m_i<3>()] * moments[m_i<3>()]) / static_cast<scalar_t>(6);  // mxx
        moments[m_i<5>()] = (static_cast<scalar_t>(6) * mxy_I - moments[m_i<1>()]) / static_cast<scalar_t>(3);                                                                                                                                                       // mxy
        moments[m_i<6>()] = mxz_I;                                                                                                                                                                                                                                   // mxz
        moments[m_i<7>()] = moments[m_i<2>()] * moments[m_i<2>()];                                                                                                                                                                                                   // myy
        moments[m_i<8>()] = (static_cast<scalar_t>(6) * myz_I - moments[m_i<3>()]) / static_cast<scalar_t>(3);                                                                                                                                                       // myz
        moments[m_i<9>()] = (-static_cast<scalar_t>(4) * mxx_I + static_cast<scalar_t>(4) * mzz_I + static_cast<scalar_t>(3) * moments[m_i<1>()] * moments[m_i<1>()] + static_cast<scalar_t>(3) * moments[m_i<3>()] * moments[m_i<3>()]) / static_cast<scalar_t>(6); // mzz
    }
    else
    {
        moments[m_i<4>()] = (static_cast<scalar_t>(6) * mxx_I - static_cast<scalar_t>(6) * mzz_I + static_cast<scalar_t>(5) * moments[m_i<1>()] * moments[m_i<1>()] + static_cast<scalar_t>(5) * moments[m_i<3>()] * moments[m_i<3>()]) / static_cast<scalar_t>(10);  // mxx
        moments[m_i<5>()] = (static_cast<scalar_t>(6) * mxy_I - moments[m_i<1>()]) / static_cast<scalar_t>(3);                                                                                                                                                        // mxy
        moments[m_i<6>()] = (static_cast<scalar_t>(6) * mxz_I) / static_cast<scalar_t>(5);                                                                                                                                                                            // mxz
        moments[m_i<7>()] = moments[m_i<2>()] * moments[m_i<2>()];                                                                                                                                                                                                    // myy                                                                                                                                                             // mxz
        moments[m_i<8>()] = (static_cast<scalar_t>(6) * myz_I - moments[m_i<3>()]) / static_cast<scalar_t>(3);                                                                                                                                                        // myz
        moments[m_i<9>()] = (-static_cast<scalar_t>(6) * mxx_I + static_cast<scalar_t>(6) * mzz_I + static_cast<scalar_t>(5) * moments[m_i<1>()] * moments[m_i<1>()] + static_cast<scalar_t>(5) * moments[m_i<3>()] * moments[m_i<3>()]) / static_cast<scalar_t>(10); // mzz
    }

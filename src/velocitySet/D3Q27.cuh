...
namespace LBM
{
    ...
    public:
         ...
         **/
        __device__ static inline void reconstruct(thread::array<scalar_t, 27> &pop, const thread::array<scalar_t, 10> &moments) noexcept
        {
         ...
         **/
        __device__ __host__ [[nodiscard]] static inline thread::array<scalar_t, 27> reconstruct(const thread::array<scalar_t, 10> &moments) noexcept
        {
            const scalar_t pics2 = static_cast<scalar_t>(1.0) - cs2<scalar_t>() * (moments[m_i<4>()] + moments[m_i<7>()] + moments[m_i<9>()]);
         ...
         **/
        __device__ static inline void reconstruct(thread::array<scalar_t, 27> &pop, const thread::array<scalar_t, 11> &moments) noexcept
        {
            const scalar_t pics2 = static_cast<scalar_t>(1.0) - cs2<scalar_t>() * (moments[m_i<4>()] + moments[m_i<7>()] + moments[m_i<9>()]);
         ...
         * @return Population array with 27 components
         **/
        __device__ static inline thread::array<scalar_t, 27> reconstruct(const thread::array<scalar_t, 11> &moments) noexcept
        {
            const scalar_t pics2 = static_cast<scalar_t>(1.0) - cs2<scalar_t>() * (moments[m_i<4>()] + moments[m_i<7>()] + moments[m_i<9>()]);
         ...
         * @return Population array with 27 components
         **/
        __host__ [[nodiscard]] static const std::array<scalar_t, 27> reconstruct(const std::array<scalar_t, 11> &moments) noexcept
        {
            const scalar_t pics2 = static_cast<scalar_t>(1.0) - cs2<scalar_t>() * (moments[m_i<4>()] + moments[m_i<7>()] + moments[m_i<9>()]);

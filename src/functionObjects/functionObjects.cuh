...
namespace LBM
{
    namespace functionObjects
    {
         ...
         **/
        const words_t &solutionVariableNames(bool isMultiphase)
        {
            static const words_t mono = {"rho", "u", "v", "w", "m_xx", "m_xy", "m_xz", "m_yy", "m_yz", "m_zz"};
            static const words_t multi = {"rho", "u", "v", "w", "m_xx", "m_xy", "m_xz", "m_yy", "m_yz", "m_zz", "phi"};
         ...
         **/
        const std::unordered_map<name_t, words_t> &fieldComponentsMap(bool isMultiphase)
        {
            static const std::unordered_map<name_t, words_t> mono = {
            ...
            static const std::unordered_map<name_t, words_t> multi = {
